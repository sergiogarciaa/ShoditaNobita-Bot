...
# Configuracion
#cargaArchivo = [21,22,23,25,53,63,80,90,110,143,161,443,500,513,520,559,3306,3389,5000,5050, 5060, 8069,8080, 9443,27017, 28017]
#cargaArchivo = [80, 443, 8080, 27017]
#nPuertos = len(cargaArchivo)

abrirArchivo = open("dic/ports.txt", "r")
...
def banner_grabbing(ip_address, port):
    ...
    try:
        ...
        s.connect((ip_address, port))
        banner = s.recv(4096)
        pct = str(porcentaje(cargaArchivo.index(port)))
...
def main():
    global cargaArchivo, nPuertos, ip_address
...
#ENTRA AQUI, PROVIENE DE LA L143
                    if Banner == "none":
                        Banner = banner_grabbing(ip_address, port)
                        print("FALLO!")
                    else:
